...
type CrossbowTypeConfig struct {
	...
	MaxRangeRecorded    float64 `json:"max_range_recorded,omitempty"`
	SpinRate            float64 `json:"spin_rate"`
	BowEfficiency       float64 `json:"bow_efficiency"`
	CrewSize            int     `json:"crew_size"`
	ReloadSeconds       float64 `json:"reload_seconds"`
	VelocityError       float64 `json:"typical_velocity_error,omitempty"`
	HistoricalNote      string  `json:"historical_note,omitempty"`
}
...
type ModernWeaponConfig struct {
	...
	AmmoStandard          string  `json:"ammo_standard,omitempty"`
	BulletMass            float64 `json:"bullet_mass"`
	BulletDiameter        float64 `json:"bullet_diameter"`
	BulletLength          float64 `json:"bullet_length"`
	OgiveRadius           float64 `json:"ogive_radius,omitempty"`
	MuzzleVelocity        float64 `json:"muzzle_velocity"`
	MuzzleEnergy          float64 `json:"muzzle_energy,omitempty"`
	MaxRange              float64 `json:"max_range"`
	EffectiveRange        float64 `json:"effective_range"`
	EffectiveRangePoint   float64 `json:"effective_range_point,omitempty"`
	EffectiveRangeArea    float64 `json:"effective_range_area,omitempty"`
	BallisticCoefG1       float64 `json:"ballistic_coefficient_g1,omitempty"`
	BallisticCoefG7       float64 `json:"ballistic_coefficient_g7,omitempty"`
	DragCoefficient       float64 `json:"drag_coefficient"`
	DragCoefStable        float64 `json:"drag_coefficient_stable,omitempty"`
	TwistRate             string  `json:"twist_rate,omitempty"`
	SpinRate              float64 `json:"spin_rate"`
	CoreMaterial          string  `json:"core_material,omitempty"`
	JacketMaterial        string  `json:"jacket_material,omitempty"`
	JacketHardnessHB      float64 `json:"jacket_hardness_hb,omitempty"`
	CoreHardnessHB        float64 `json:"core_hardness_hb,omitempty"`
	AverageHardness       float64 `json:"average_hardness,omitempty"`
	Hardness              float64 `json:"hardness"`
	TipArea               float64 `json:"tip_area"`
	CrewSize              int     `json:"crew_size"`
	ReloadSeconds         float64 `json:"reload_seconds"`
	CyclicRateRPM         float64 `json:"cyclic_rate_rpm,omitempty"`
	DataSource            string  `json:"data_source,omitempty"`
	PenetrationReference  string  `json:"penetration_reference,omitempty"`
}
